...
const UI4_PORTUGUESE_SPRITE_PLACEMENT_PATCHES = new Map<number, Map<string, { tx?: number; ty?: number; scaleX?: number }>>([
    ...
    [2948, new Map([['17:2947', { scaleX: 1, tx: -441 }]])], // Re-encode the matrix and move the longer label 15 px left.
    [3953, new Map([['3:3952', { tx: -168 }]])], // Center the wider catalyst tooltip text field.
    [4001, new Map([['51:4000', { tx: -861 }]])], // Center the longer PT-BR talent training title.
]);
const UI4_DEFINE_EDIT_TEXT_REPLACEMENTS = new Map<number, StringReplacement[]>([
    ...
    [260, [{ oldValue: 'Legendary Bonus', newValue: 'Bônus Lendário' }]],
    [325, [{ oldValue: 'You will never reforge the same property twice', newValue: 'Você nunca reforjará o mesmo atributo' }]],
    ...
    [2926, [{ oldValue: 'Chance to craft a rare charm', newValue: 'Chance de criar uma gema rara' }]],
    [2927, [{ oldValue: 'Chance to craft a legendary charm', newValue: 'Chance de criar uma gema lendária' }]],
    [2947, [{ oldValue: 'Catalyst', newValue: 'Catalisador' }]],
    [2283, [{ oldValue: 'Requires: Tome Level 10', newValue: 'Requisitos: Tomo Nível 10' }]],
    [3993, [{ oldValue: 'Spend Idols', newValue: 'Gastar Idols' }]],
    [3998, [{ oldValue: 'Spend Gold', newValue: 'Gastar Ouro' }]],
    [4000, [{ oldValue: 'Train Talent Point', newValue: 'Treinar Ponto de Talento' }]],
...
const UI4_PORTUGUESE_EDIT_TEXT_BOUNDS = new Map<number, { xmin: number; xmax: number }>([
    ...
    [2926, { xmin: -40, xmax: 4500 }],
    [2947, { xmin: -40, xmax: 2000 }],
    [3952, { xmin: -40, xmax: 4080 }],
...
const BRAZILIAN_PORTUGUESE_DISCIPLINE_REPLACEMENTS: StringReplacement[] = [
    ...
    {
        oldValue: 'How would you like to pay to begin your upgrade?',
        newValue: 'Como você gostaria de pagar para iniciar o upgrade?'
    },
    {
        oldValue: 'How would you like to pay to begin your training?',
        newValue: 'Como você gostaria de pagar para iniciar seu treinamento?'
    },
    {
        oldValue: 'How would you like to pay to begin the training?',
        newValue: 'Como você gostaria de pagar para iniciar o treinamento?'
    },
    { oldValue: 'Train Talent Point', newValue: 'Treinar Ponto de Talento' },
    { oldValue: 'Train Ability Rank', newValue: 'Treinar Nível de Habilidade' },
    ...
    { oldValue: 'UI_4.swf', newValue: `UI_4.swf?rv=${SWF_RUNTIME_VERSION}` },
    ...
    { oldValue: 'LevelsBT.swf', newValue: `LevelsBT.swf?rv=${SWF_RUNTIME_VERSION}` },
    { oldValue: 'LevelsCH.swf', newValue: `LevelsCH.swf?rv=${SWF_RUNTIME_VERSION}` },
...
export const BRAZILIAN_PORTUGUESE_UI4_REPLACEMENTS: StringReplacement[] = [
    {
        oldValue: "Reforge a charm's bonus property into a random property from the list below.",
        newValue: 'Troque o atributo bônus de uma gema por outro aleatório da lista abaixo.'
    },
    {
        oldValue: 'You will never reforge the same property twice',
        newValue: 'Você nunca reforjará o mesmo atributo'
    },
    { oldValue: 'Reforge Bonus Property', newValue: 'Reforjar Atributo Bônus' },
    { oldValue: 'Keep This One', newValue: 'Ficar com Este' },
    { oldValue: 'Current Bonus', newValue: 'Bônus Atual' },
    { oldValue: 'Legendary Charm', newValue: 'Gema Lendária' },
    { oldValue: 'Legendary Bonus', newValue: 'Bônus Lendário' },
    { oldValue: 'Add Catalyst', newValue: 'Adicionar Catalisador' },
    { oldValue: 'Chance to craft a rare charm', newValue: 'Chance de criar uma gema rara' },
    { oldValue: 'Chance to craft a legendary charm', newValue: 'Chance de criar uma gema lendária' },
    { oldValue: 'Choose a Catalyst', newValue: 'Escolha um Catalisador' },
    { oldValue: 'Reforge', newValue: 'Reforjar' },
    { oldValue: 'Catalyst', newValue: 'Catalisador' },
    { oldValue: 'Discipline Masteries', newValue: 'Maestrias da Disciplina' },
    { oldValue: 'Select an ability on the left to upgrade', newValue: 'Selecione uma habilidade para aprimorá-la' },
    ...
    { oldValue: 'Gained Talent Point - ', newValue: 'Ponto de Talento Adquirido - ' },
...
export const BRAZILIAN_PORTUGUESE_LEVELS_BT_REPLACEMENTS: StringReplacement[] = [
    ...
    { oldValue: 'Sergeant Svagg', newValue: 'Sargento Svagg' },
    {
        oldValue: "Without the goblin's spells, you'll die here.:This forest is ours!",
        newValue: 'Sem os feitiços dos goblins, você vai morrer aqui.:Essa floresta é nossa!'
    },
    { oldValue: "Without the goblin's spells, you'll die here.", newValue: 'Sem os feitiços dos goblins, você vai morrer aqui.' },
    {
        oldValue: "A goblin's skull can enchant 100 spiders.:Care to meet them?",
        newValue: 'O crânio de um goblin pode encantar 100 aranhas.:Que tal conhecê-las?'
    },
    { oldValue: 'Care to meet them?', newValue: 'Que tal conhecê-las?' },
    { oldValue: 'How can these bandits stand those things?', newValue: 'Como esses bandidos aguentam essas coisas?' },
    {
        oldValue: 'You fought goblins, sure.:But not goblin magic under human command!',
        newValue: 'Você lutou contra goblins, claro.:Mas não contra magia goblin sob comando humano!'
    },
    { oldValue: 'But not goblin magic under human command!', newValue: 'Mas não contra magia goblin sob comando humano!' },
    { oldValue: 'Wrath, avenge me!', newValue: 'Fúria, vingue minha morte!' },
    { oldValue: 'Fala localizada E42EB3.', newValue: 'Seu idiota maldito!' },
    { oldValue: 'You cursed fool!', newValue: 'Seu|Sua idiota maldito|maldita!' },
    { oldValue: "He's|She's from the King!", newValue: 'Ele|Ela foi enviado|enviada pelo Rei!' },
    {
        oldValue: "He's|She's from the King!:Come to take us back in chains!",
        newValue: 'Ele|Ela foi enviado|enviada pelo Rei!:Veio nos levar de volta acorrentados!'
    },
];

export const BRAZILIAN_PORTUGUESE_LEVELS_CH_REPLACEMENTS: StringReplacement[] = [
    // Dungeon entrance signs embedded in the Cemetery Hill level SWF.
    { oldValue: 'Os Condenados se Erguer', newValue: 'Condenados se Erguem' },
    { oldValue: 'Os Condenados se Erguem', newValue: 'Condenados se Erguem' },
    // Rising Damned boss intro and display name.
    { oldValue: 'Aquele voice...', newValue: 'Essa voz...' },
    { oldValue: 'That vocêice...', newValue: 'Essa voz...' },
    { oldValue: 'That voice...', newValue: 'Essa voz...' },
    // Boss display names (health bar labels come from entity names in the level SWF)
    { oldValue: "Lord Tilly's Rest", newValue: 'Descanso do Lorde Tilly' },
    { oldValue: 'Lord Tilly’s Rest', newValue: 'Descanso do Lorde Tilly' },
    { oldValue: 'Kamak the Packlord', newValue: 'Kamak, Senhor da Matilha' },
    { oldValue: 'Rafhiu the Liberator', newValue: 'Rafhiu, o Libertador' },
    { oldValue: 'Ravenous Drake', newValue: 'Dragão Voraz' },
    { oldValue: 'Nephit the Great and Wise', newValue: 'Nephit, o Grande e Sábio' },
    { oldValue: 'Nephit the Terrible', newValue: 'Nephit, o Terrível' },
    { oldValue: 'Lord Tilly', newValue: 'Lorde Tilly' },
    { oldValue: 'Baron Hocke', newValue: 'Barão Hocke' },
    { oldValue: 'Queen Kyria the Terrifying', newValue: 'Rainha Kyria, a Terrível' },
];
...
const BRAZILIAN_PORTUGUESE_MAIN_SWF_SAFE_REPLACEMENTS: StringReplacement[] = [
    ...
    // Felbridge NPC titles
    { oldValue: 'Warden Maximilian', newValue: 'Guardião' },
    { oldValue: 'Steward of Felbridge', newValue: 'Intendente' },
    { oldValue: 'No Quests Available', newValue: 'Não há missões disponíveis' },
    { oldValue: 'Quest Available\nTalk to ', newValue: 'Missão Disponível\nFale com ' },
    { oldValue: 'Quest Available\nHead to ', newValue: 'Missão Disponível\nVá para ' },
    { oldValue: 'Quest Available', newValue: 'Missão Disponível' },
    ...
    { oldValue: 'Click on Mayor Ristas to hear more about your quest', newValue: 'Clique no Prefeito Ristas para saber mais da missão' },
    { oldValue: 'Talk to Captain Fink', newValue: 'Fale com o Capitão Fink' },
    { oldValue: 'Talk to Captain Gar', newValue: 'Fale com o Capitão Gar' },
    { oldValue: 'Talk to Mayor Ristas', newValue: 'Fale com o Prefeito Ristas' },
...
function getReplacements(mode: DungeonBlitzSwfMode, locale: DungeonBlitzSwfLocale): StringReplacement[] {
    ...
    if (mode === 'local') {
        return [
            ...
            { oldValue: NEXT_REMOTE_REFRESH_URL, newValue: localRefreshUrl },
            { oldValue: NEXT_REMOTE_REFRESH_URL_LEGACY, newValue: localRefreshUrl },
            { oldValue: NEXT_LOCAL_REFRESH_URL, newValue: localRefreshUrl },
            { oldValue: NEXT_LOCAL_REFRESH_URL_LEGACY, newValue: localRefreshUrl },
            ...
            { oldValue: PRE_CACHE_BUST_REMOTE_REFRESH_URL, newValue: localRefreshUrl },
            { oldValue: PRE_CACHE_BUST_REMOTE_REFRESH_URL_LEGACY, newValue: localRefreshUrl },
            { oldValue: PRE_CACHE_BUST_LOCAL_REFRESH_URL, newValue: localRefreshUrl },
            { oldValue: PRE_CACHE_BUST_LOCAL_REFRESH_URL_LEGACY, newValue: localRefreshUrl },
            { oldValue: FINAL_PRE_CACHE_BUST_REMOTE_REFRESH_URL, newValue: localRefreshUrl },
    ...
    return [
        ...
        { oldValue: NEXT_LOCAL_REFRESH_URL, newValue: remoteRefreshUrl },
        { oldValue: NEXT_LOCAL_REFRESH_URL_LEGACY, newValue: remoteRefreshUrl },
        { oldValue: NEXT_REMOTE_REFRESH_URL, newValue: remoteRefreshUrl },
        { oldValue: NEXT_REMOTE_REFRESH_URL_LEGACY, newValue: remoteRefreshUrl },
        ...
        { oldValue: PRE_CACHE_BUST_LOCAL_REFRESH_URL, newValue: remoteRefreshUrl },
        { oldValue: PRE_CACHE_BUST_LOCAL_REFRESH_URL_LEGACY, newValue: remoteRefreshUrl },
        { oldValue: PRE_CACHE_BUST_REMOTE_REFRESH_URL, newValue: remoteRefreshUrl },
        { oldValue: PRE_CACHE_BUST_REMOTE_REFRESH_URL_LEGACY, newValue: remoteRefreshUrl },
        { oldValue: FINAL_PRE_CACHE_BUST_LOCAL_REFRESH_URL, newValue: remoteRefreshUrl },
...
function buildBrazilianPortugueseEmotePatches(
    ...
    const usesDynamicMenuLayout = menuCode
        .subarray(dynamicMenuInsertionOffset, dynamicMenuInsertionOffset + dynamicExpectedMenuInsertionBytes.length)
        .equals(dynamicExpectedMenuInsertionBytes);
    if (!usesLegacyMenuLayout && !usesDynamicMenuLayout) {
    ...
    for (const [source, label] of BRAZILIAN_PORTUGUESE_EMOTE_MENU_REPLACEMENTS) {
        const assignLabel = Buffer.concat([
            ...
            Buffer.from([0x85, 0x63, menuLabelLocalRegister])
        ]);
        labelCodeChunks.push(Buffer.concat([
            Buffer.from([0x62, menuLabelLocalRegister]),
    ...
    const usesDynamicCommandLayout = commandCode
        .subarray(dynamicCommandInsertionOffset, dynamicCommandInsertionOffset + dynamicExpectedInsertionBytes.length)
        .equals(dynamicExpectedInsertionBytes);
    if (!usesLegacyCommandLayout && !usesDynamicCommandLayout) {
...
const BRAZILIAN_PORTUGUESE_MAIN_SWF_DISCIPLINE_SCREEN_LABEL_PATCHES = [
    { methodIdx: 1151, offset: 287, expected: 'Tricks o’ Trade' },
    { methodIdx: 1151, offset: 290, expected: 'Ambush & Onslaught' },
    { methodIdx: 1151, offset: 293, expected: 'From the Shadows' },
    { methodIdx: 1151, offset: 296, expected: 'The Dark Arts' },
    { methodIdx: 1151, offset: 299, expected: 'Discipline Masteries' },
    { methodIdx: 1151, offset: 337, expected: 'Discipline Masteries' }
];
...
function buildBrazilianPortugueseChatChannelLabelPatches(
    ...
    for (const [methodIdx, methodBody] of abc.methodBodies) {
        ...
        for (const instruction of instructions) {
            ...
            const operandEnd = methodBody.codeStart + instruction.offset + instruction.size;
            if (replacementOperand.length !== operandEnd - operandStart) {
                throw new Error(`PT-BR chat channel label "${newValue}" changed pushstring operand width at m${methodIdx}:${instruction.offset}`);
            }

            patches.push({
                key: `ptbr-chat-channel-label:${methodIdx}:${instruction.offset}`,
                start: operandStart,
                end: operandEnd,
                data: replacementOperand,
                detail: `localize chat channel label ${oldValue} -> ${newValue}`
            });
        }
    }
...
function buildBrazilianPortugueseChatCommandMenuLabelPatches(
    ...
    const methodIdx = methodIdxForTrait(abc.instances[chatClassIndex].traits, abc, 'method_1237');
    if (methodIdx === null) {
        return [];
    }
    ...
    const code = ctx.body.subarray(methodBody.codeStart, methodBody.codeStart + methodBody.codeLen);
    const instruction = disassemble(code, `m${methodIdx}`).find((candidate) => {
        const oldIndex = candidate.operands[0]?.[1];
        return candidate.opcode === 0x2c && abc.stringValues[oldIndex] === 'Leave';
    });
    if (!instruction) {
...
function buildBrazilianPortuguesePushDoubleOperandPatch(
    ...
    const code = ctx.body.subarray(methodBody.codeStart, methodBody.codeStart + methodBody.codeLen);
    const instruction = disassemble(code, `m${methodIdx}`).find((candidate) => candidate.offset === offset);
    if (!instruction || instruction.opcode !== 0x2f || instruction.operands[0]?.[1] !== oldIndex) {
        return null;
    }
...
function buildBrazilianPortugueseItemTypeLabelPatches(
    ...
    const directItemLabelReplacements = new Map<string, string>([
        ...BRAZILIAN_PORTUGUESE_ITEM_TYPE_LABELS,
        ['Add Catalyst', 'Adicionar Catalisador'],
        ['Legendary Bonus', 'BÃ´nus LendÃ¡rio'],
        ['Crafting Materials', 'Materiais de CriaÃ§Ã£o'],
        ['Charms', 'Gemas']
    ]);
    ...
    for (const [methodIdx, methodBody] of [] as Array<[number, NonNullable<ReturnType<typeof parseAbc>['methodBodies'] extends Map<number, infer T> ? T : never>]>) {
        ...
        for (const instruction of instructions) {
            ...
            const oldIndex = instruction.operands[0]?.[1];
            const oldValue = abc.stringValues[oldIndex];
            const newValue = directItemLabelReplacements.get(oldValue);
            if (!newValue) {
                continue;
            }
            ...
            const operandStart = methodBody.codeStart + instruction.offset + 1;
            const operandEnd = methodBody.codeStart + instruction.offset + instruction.size;
            const operandKey = `${operandStart}:${operandEnd}`;
            if (patchedOperands.has(operandKey)) {
                continue;
            }
            if (replacementOperand.length !== operandEnd - operandStart) {
                continue;
            ...
            patchedOperands.add(operandKey);
            patches.push({
                key: `ptbr-item-type-label:auto:${methodIdx}:${instruction.offset}`,
                start: operandStart,
                end: operandEnd,
                data: replacementOperand,
                detail: `localize displayed PT-BR item/inventory label ${oldValue} -> ${newValue}`
            });
        }
    }
